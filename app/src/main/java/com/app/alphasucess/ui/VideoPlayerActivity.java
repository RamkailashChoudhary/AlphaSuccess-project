...
import com.app.alphasucess.Sample.UriSample;
import com.app.alphasucess.TrackSelectionDialog;
...
public class VideoPlayerActivity extends BaseActivity
    ...
    private void initializePlayer() {
        if (player == null) {
            ...
            RenderersFactory renderersFactory =
                    ((MyApplication) getApplication()).buildRenderersFactory(preferExtensionDecoders);
    ...
    private HttpMediaDrmCallback createMediaDrmCallback(
        ...
        HttpDataSource.Factory licenseDataSourceFactory =
                ((MyApplication) getApplication()).buildHttpDataSourceFactory();
            ...
            MediaSourceFactory adMediaSourceFactory =
                    new MediaSourceFactory() {
                        ...
                        public MediaSource createMediaSource(Uri uri) {
                            return VideoPlayerActivity.this.createLeafMediaSource(
