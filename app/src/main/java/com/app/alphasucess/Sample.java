...
import static com.app.alphasucess.ui.VideoPlayerActivity.ACTION_VIEW_LIST;
import static com.app.alphasucess.ui.VideoPlayerActivity.AD_TAG_URI_EXTRA;
import static com.app.alphasucess.ui.VideoPlayerActivity.DRM_KEY_REQUEST_PROPERTIES_EXTRA;
import static com.app.alphasucess.ui.VideoPlayerActivity.DRM_LICENSE_URL_EXTRA;
import static com.app.alphasucess.ui.VideoPlayerActivity.DRM_MULTI_SESSION_EXTRA;
import static com.app.alphasucess.ui.VideoPlayerActivity.DRM_SCHEME_EXTRA;
import static com.app.alphasucess.ui.VideoPlayerActivity.DRM_SCHEME_UUID_EXTRA;
import static com.app.alphasucess.ui.VideoPlayerActivity.EXTENSION_EXTRA;
import static com.app.alphasucess.ui.VideoPlayerActivity.IS_LIVE_EXTRA;
import static com.app.alphasucess.ui.VideoPlayerActivity.SUBTITLE_LANGUAGE_EXTRA;
import static com.app.alphasucess.ui.VideoPlayerActivity.SUBTITLE_MIME_TYPE_EXTRA;
import static com.app.alphasucess.ui.VideoPlayerActivity.SUBTITLE_URI_EXTRA;
import static com.app.alphasucess.ui.VideoPlayerActivity.URI_EXTRA;
...
public abstract class Sample {
    ...
    public static final class UriSample extends Sample {
        ...
        public @Nullable SubtitleInfo subtitleInfo;
        ...
        public void addToIntent(Intent intent) {
            intent.setAction(VideoPlayerActivity.ACTION_VIEW).setData(uri);
            intent.putExtra(VideoPlayerActivity.IS_LIVE_EXTRA, isLive);
            intent.putExtra(VideoPlayerActivity.SPHERICAL_STEREO_MODE_EXTRA, sphericalStereoMode);
        ...
        public void addToPlaylistIntent(Intent intent, String extrasKeySuffix) {
            ...
            intent.putExtra(VideoPlayerActivity.IS_LIVE_EXTRA + extrasKeySuffix, isLive);
            addPlayerConfigToIntent(intent, extrasKeySuffix);
        }
